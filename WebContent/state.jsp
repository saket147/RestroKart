...
<div class="container">
		<div class="row">
			<div class="col-sm-3">
				<form action="StoreState.do" method="post">
					<p  class="form-row form-row-first validate-required">
            			<label class="" >State Name <abbr title="required" class="required">*</abbr>
            			</label>
               	     <input type="text" value="" placeholder="eg. Uttar Pradesh" id="state_name" name="state_name" class="input-text my">
             	  </p>             	
				<div class="form-row place-order">
                     <input type="submit" data-value="Place order" value="Add State" id="place_order" name="woocommerce_checkout_place_order" class="btn btn-primary">
                </div>
                <div class="clear"></div>
				</form>
			</div>
